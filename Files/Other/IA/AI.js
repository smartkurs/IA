var qmakeVers = '2.0';
var qmakeProgName = "smartkurs";
var qmakeURL = 'www.smartkurs.com/';
var dhtmlEnabled = 1;
var html5Enabled = 1;
var frameEnabled = 0;
...
function initShortQuestion() {
 qstHead[0]="1 Complete the questions in the dialogue with the phrases below  ";
 qstHead[1]="3 listen and repeat the alphabet. What sound do the blue letters share? ";
 qstHead[2]="4  Now put the red letters into the correct category below depending on the...";
 qstHead[3]="7 Listen to two dialogues. Complete the table with the names and ages of th...";
 qstHead[4]="8 VOCABULARY Which country are the students in exercise 7 from? Listen agai...";
 qstHead[5]="10  Answer the questions about the countries in exercise 8  ";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,3,4,4,4,4);
